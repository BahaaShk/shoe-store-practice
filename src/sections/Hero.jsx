...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="max-xl:padding-x relative flex w-full flex-col items-start justify-center pt-28 xl:w-[40%]">
        <p className="font-montserrat text-xl text-coral-red max-sm:hidden">
          Our Summer Collection
        </p>
        <h1 className="mt-10 font-palanquin text-8xl font-bold max-sm:text-[72px] max-sm:leading-[82px] max-sm:mt-[85px]">
